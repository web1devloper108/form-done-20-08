    ...
    switch (activeTab) {
      ...
      case "Quarterly":
        return (
          <>
            <div className="document-item">
              <span>Upload IP Status* <span className="mandatory">Mandatory</span></span>
              <button className="upload-button">Upload File</button>
            </div>
            <div className="document-item">
              <span>Upload Job Creation Sheet <span className="mandatory">Mandatory</span></span>
              <button className="upload-button">Upload File</button>
            </div>
            <div className="document-item">
              <span>GST Filled <span className="mandatory">Mandatory</span></span>
      ...
      case "Annually":
        return (
          <>
            ...
            <div className="document-item">
              <span>ITR Filling <span className="mandatory">Mandatory</span></span>
              <button className="upload-button">Upload File</button>
            </div>
            <div className="document-item">
              <span>Updated Investments <span className="mandatory">Mandatory</span></span>
              <button className="upload-button">Upload File</button>
            </div>
            <div className="document-item">
              <span>Growth in terms of revenue / Product development / Customer Acquisition <span className="mandatory">Mandatory</span></span>
              <button className="upload-button">Upload File</button>
            </div>
          </>
        );
